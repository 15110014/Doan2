...
?>
                ...
                <?php
                    if(isset($_GET['selected'])){
                        ...
                        if(mysqli_num_rows($result) > 0){
                            ...
                            while($r = mysqli_fetch_assoc($result)){
                                $i++;
                                echo "Tên ghi chú: " .htmlentities($r['tenText']);
    ...
    <?php
        ...
        if(mysqli_num_rows($result) > 0){
            ...
            while($r = mysqli_fetch_assoc($result)){
                ...
                echo "Tên ghi chú: " .htmlentities($r['name']);
                echo "</br>Nội dung ghi chú: " .htmlentities($r['texts']);
                echo "</div>";
            }
        }else{
            echo "Data empty";
    ...
    <?php
        ...
        if(isset($_POST['submit'])){
            $tenText = htmlspecialchars($_POST['textName']);
